        ...
        <section className="relative w-full h-full py-40 min-h-screen">
          ...
          <div className="container mx-auto px-4 h-full">
            <div className="flex content-center items-center justify-center h-full">
              ...
              <h1 className="text-4xl font-semibold text-center mb-10">Schedule Offline Exam</h1>
                        ...
                        <label className="w-1/3" >Location : </label>
                          <select className="text-sm border-2 rounded p-1 border-solid  focus:outline-none focus:ring w-full ease-linear transition-all duration-150 ">
                            ...
                            <div className="flex form-check">
                              ...
                              <label className="text-sm form-check-label inline-block text-gray-800 w-full" htmlFor="flexCheckDefault">
                                I hereby confirm the offline exam date for the enrolled course and agree to bring a print of QR Certificate at the time of exam.
                              </label>
                      </div>
